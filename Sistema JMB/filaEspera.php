...
<body>
    <div class="header">
        ...
        <div class="botoes">
            <a href="filaAgendamento.php" class="botoes-secao hover">Agendamento</a>
            <a href="filaEspera.php" class="botoes-secao selecionado">Espera</a>
    ...
    <div class="container-main">
        <div class="lista">
            ...
            $query = "
                ...
                WHERE s.fila = 'Espera' AND s.stattus IN ('Pendente', 'Em Andamento')
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<div class='linha-servico'><div class='coluna' colspan='7'>Nenhum serviço na fila de espera</div></div>";
            }
